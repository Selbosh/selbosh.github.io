...
On each day, we can shuffle the fish along the vector, decreasing the number of days for each group of fish by 1, and adding new cohorts of fish at day 6, to represent parent fish resetting their tiemrs, and at day 8 to represent the newly hatched lanternfish.
...
If you find this confusing, you can index from zero instead with the new [**index0** package](https://github.com/Selbosh/index0):
