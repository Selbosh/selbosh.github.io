...
To avoid loading any external packages at this stage, I defined my own base R function called [`rolling_sum()`](https://github.com/Selbosh/adventofcode2021/blob/main/R/day01.R#L99-101), which uses `tail` and `head` with negative lengths to omit the first and last elements of the vector:
