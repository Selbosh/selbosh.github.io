...
There may be a way of vectorizing the inner loops here by using a vector of coordinates.
The function `which(..., arr.ind = TRUE)` might be handy for such an approach.
