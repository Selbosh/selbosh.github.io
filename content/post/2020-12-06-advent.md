...
*(The maximum card will __never__ trigger a sub-sub-game, because the maximum
value in a set of distinct natural numbers is always greater than or equal to
the size of that set. You could even use this fact to skip the main game of
recursive combat---if you didn't need to know the final score.)*
