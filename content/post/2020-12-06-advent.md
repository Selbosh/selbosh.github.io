...
at this point, we can assume that one of the previous instructions was corrupted
and swap them in turn until the program terminates successfully.

There's possibly an efficient way of iterating through the possibilities in
order, but I just decided to 'brute force' it, which appears to
