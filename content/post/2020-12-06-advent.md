...
I am not sure what the best way is to count the possible lengths of matches
to a regular expression but in this case I used `'\([^)]*\)'`, which
detects pairs of brackets that do not contain other brackets. The
